...
“前沿”位于分类首位，日期文件夹倒序排列，每期五块：AI 动态（每日 15 条，优先大厂重要发布与有热度证据的 AI 项目；5 条重点详解 + 10 条速读）、开源模型、论文精选、GitHub 热门、技术实践。重点新闻每条约 500–800 字，解释变化、原理、用途和开放范围。详细来源、图文、专题跟踪和论文归档规则见 [编辑规则](docs/frontiers-editorial.md)。北京时间 07:30 启动，目标 08:30 前完成上线供阅读。自动整理在本地 Mac 上由 Codex 调度；仓库的 GitHub Actions 负责构建与发布，不负责定时 AI 采集。
