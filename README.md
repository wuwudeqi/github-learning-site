...
“前沿”位于分类首位，日期文件夹倒序排列，每期五块：AI 动态（最多 10 条）、开源模型、论文精选、GitHub 热门、技术实践。详细来源、图文、专题跟踪和论文归档规则见 [编辑规则](docs/frontiers-editorial.md)。自动整理在本地 Mac 上由 Codex 调度；仓库的 GitHub Actions 负责构建与发布，不负责定时 AI 采集。
