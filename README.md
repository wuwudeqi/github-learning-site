...
一个部署在 GitHub Pages 上的个人阅读资料库。PDF、Markdown 和阅读器资源均由本站提供，无外部 CDN、字体或在线预览服务。

## 已实现

- 桌面与手机书架，论文 / 书籍 / 笔记分类、文件类型筛选与排序。
- 标题、作者、标签、简介及 Markdown 正文搜索。PDF 暂不做全文检索。
...
附带 3 篇原创中文示例笔记、2 份原创英文 PDF 演示稿。它们不是正式出版书籍或研究论文，可直接删除或替换。没有伪造阅读记录。
